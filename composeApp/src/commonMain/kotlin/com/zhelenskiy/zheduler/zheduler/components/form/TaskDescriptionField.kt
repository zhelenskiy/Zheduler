...
fun TaskDescriptionField(
    ...
    // Read every time, not snapshotted once: the settings arrive from disk after the first form
    // is composed, so taking the value once ignored the choice stored for this task.
